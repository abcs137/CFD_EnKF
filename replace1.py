...
def replace1(templants):
    ...
    # 读取文件内容
    with open(f'.\{templants}\{templants}.ccl', 'r') as f:
    ...
    for index, segment in enumerate(segments):
        ...
        # 生成新文件名
        new_filename = f'.\{templants}\{templants}_{index + 1:03d}.ccl'
    ...
    os.remove(f'.\{templants}\{templants}.ccl');
